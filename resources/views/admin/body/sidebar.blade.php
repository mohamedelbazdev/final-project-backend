    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="">Ctaegory</a></li>
                    <li class="nav-item"> <a class="nav-link" href="">SubCategory</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="district">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href=""> District </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> SubDistrict </a>
                    </li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="post">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href=""> Add Post </a>
                    </li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="setting">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href=""> Social
                            Settings </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> SEO Settings
                        </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> Prayers
                            Settings </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> Live Tv
                            Settings </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> Notice
                            Settings </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> Website
                            Settings </a></li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="website">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href=""> Add Website
                            Link </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> All website
                            Links </a></li>
            ...
            <div class="collapse" id="photo">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href=""> Photo
                            Gallery</a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> Video Gallery
                        </a></li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href=""> Add Author </a></li>
                    <li class="nav-item"> <a class="nav-link" href=""> All Authors </a></li>
