              ...
              <div class="card-body px-5 py-5">
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input id="name"  type="text" name="name"  class="form-control p_input">
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                  ...
                  <div class="form-group">
                    ...
                    <input id="password_confirmation" type="password" name="password_confirmation"  class="form-control p_input">
                  </div>
